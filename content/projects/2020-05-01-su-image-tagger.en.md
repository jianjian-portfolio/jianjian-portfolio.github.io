...
{{< figure-grid caption="Screenshots of the tagging system" screenshots="true" >}}
{{< figure-item src="/assets/images/projects/pdf_image_annotator_1.jpg" alt="Project dashboard" caption="Dashboard" >}}
{{< figure-item src="/assets/images/projects/pdf_image_annotator_2.jpg" alt="Annotation workflow" caption="Annotation modal" >}}
{{< /figure-grid >}}
